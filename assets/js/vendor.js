...
!(function (a, b) {
  ...
  return (
    ...
    (b.prototype.add_polyEv = function (a) {
      var b = this;
      google.maps.event.addListener(this[a].getPath(), "set_at", function (
        c,
        d
      ) {
        b.trigger_polyEv(a, c, d);
      }),
        google.maps.event.addListener(this[a].getPath(), "insert_at", function (
          c,
          d
        ) {
          b.trigger_polyEv(a, c, d);
    ...
    (b.prototype.create = {
      ...
      directions: function () {
        ...
        (this.o.directions_options.origin = e),
          ...
          this.directionsService.route(this.o.directions_options, function (
            a,
            b
          ) {
